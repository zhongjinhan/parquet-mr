...
import parquet.thrift.test.compat.ListOfUnions;
import parquet.thrift.test.compat.MapWithUnionKey;
import parquet.thrift.test.compat.MapWithUnionValue;
import parquet.thrift.test.compat.NestedNestedUnion;
import parquet.thrift.test.compat.NestedUnion;
import parquet.thrift.test.compat.OptionalInsideRequired;
import parquet.thrift.test.compat.RequiredInsideOptional;
import parquet.thrift.test.compat.StructWithNestedUnion;
import parquet.thrift.test.compat.StructWithOptionalUnionOfStructs;
import parquet.thrift.test.compat.UnionOfStructs;
import parquet.thrift.test.compat.UnionV2;
import org.junit.Test;

import static parquet.thrift.TestThriftSchemaConverter.shouldGetProjectedSchema;
