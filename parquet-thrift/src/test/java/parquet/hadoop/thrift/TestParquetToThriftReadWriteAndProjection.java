...
import parquet.thrift.test.compat.MapWithPrimMapValue;
import parquet.thrift.test.compat.MapWithStructMapValue;
import parquet.thrift.test.compat.MapWithStructValue;
...
public class TestParquetToThriftReadWriteAndProjection {
  ...
  // The selected group cannot be materialized because no columns are selected
