...
public class TestParquetFileWriter {
  ...
  public void testConvertToThriftStatistics() throws Exception {
    ...
    Statistics thriftStats =
        parquet.format.converter.ParquetMetadataConverter.toParquetStatistics(parquetMRstats);
    LongStatistics convertedBackStats =
        (LongStatistics) parquet.format.converter.ParquetMetadataConverter.fromParquetStatistics(
