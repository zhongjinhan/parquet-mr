...
import static parquet.bytes.BytesUtils.intToBytes;
import static parquet.bytes.BytesUtils.longToBytes;
...
public class TestStatistics {
  ...
  public void testSpecBuilderForFloat() {
    Statistics.Builder builder = Statistics.getBuilderForReading(FLOAT);
    ...
    builder = Statistics.getBuilderForReading(FLOAT);
  ...
  public void testSpecBuilderForDouble() {
    Statistics.Builder builder = Statistics.getBuilderForReading(DOUBLE);
    ...
    builder = Statistics.getBuilderForReading(DOUBLE);
